import { DevsTypes } from "./interface";

export const Devs: DevsTypes[] = [
  {
    ...
    gitHub: "https://github.com/joseph-w-valdez",
  ...
  },
  {
    ...
    role: "Lead Developer",
    bio: `After leaving my previous position, I embarked on a journey to enhance my skills and pursue my dream career. I've refocused my efforts on becoming a software engineer, honing my skills in TypeScript, HTML, and CSS. My ultimate goal is to excel as a Software Engineer.`,
    linkedIn: "https://www.linkedin.com/in/lambpato/",
    gitHub: "https://github.com/Lambpato/Lambpato",
    portfolio: "https://lamberto-martinez.vercel.app/",
  ...
  },
  {
    ...
    name: "Kevin Lay",
    role: "Developer",
    bio: `Kevin here! Full Stack Web Developer adept in JavaScript, React, HTML5, CSS3, PostgreSQL, and more. With a background in small business management, I've transitioned into tech, completing an accelerated Web Development course at LearningFuze. Now, I'm passionate about crafting user-friendly interfaces and always eager to connect with fellow tech enthusiasts. Let's chat!`,
  ...
  },
  {
    ...
    bio: `I'm a Full Stack Web Developer with a passion for creativity, design, and front-end development. My work is driven by a desire to create visually appealing and engaging user experiences. Outside of coding, I enjoy hiking, exploring new music and collecting vinyl.`,
